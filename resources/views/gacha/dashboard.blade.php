    ...
    <section class="grid gap-6 lg:grid-cols-3">
        <article class="rounded-2xl border border-amber-200 bg-linear-to-br from-amber-50/50 via-white to-white p-6 shadow-xl shadow-amber-100/50 transition-colors duration-300 dark:border-amber-300/40 dark:from-amber-500/25 dark:via-slate-900 dark:to-slate-950 dark:shadow-lg dark:shadow-amber-500/20 sm:p-8 lg:col-span-2">
            ...
            <div class="mt-8 flex flex-col gap-3 sm:flex-row">
                <a href="{{ route('gacha.pull-animation') }}" class="inline-flex items-center justify-center gap-2 rounded-xl bg-amber-500 px-6 py-3.5 font-bold text-white shadow-lg shadow-amber-500/30 transition duration-200 hover:bg-amber-600 hover:shadow-amber-600/40 active:scale-95 dark:bg-amber-400 dark:text-slate-900 dark:shadow-amber-500/40 dark:hover:bg-amber-300 dark:hover:shadow-amber-400/60">
                    🎯 Lancer un tirage
                </a>
                <a href="{{ route('characters.index') }}" class="inline-flex items-center justify-center gap-2 rounded-xl border-2 border-slate-200 bg-white px-6 py-3.5 font-bold text-slate-700 shadow-sm transition duration-200 hover:bg-slate-50 hover:text-slate-900 dark:border-slate-500 dark:bg-transparent dark:text-slate-100 dark:shadow-none dark:hover:border-slate-300 dark:hover:bg-slate-700">
